...
* Added `PROMETHEUS` protocol to `viettelidc_lb_listener_v2` resource ([#1494](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/pull/1494))
...
* Fixed `lb_members_v2` documentation ([#1340](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/pull/1340))
...
* Improved removal of `networking_router_interface_v2` resource so it will delete only needed port on a router ([#1297](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/pull/1297))
...
* Added `image_source_username`, `image_source_password` arguments to `images_image_v2` resource ([#1157](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/pull/1157))
...
* Added `multiattach` argument and attribute for the `viettelidc_blockstorage_volume_v3` resource ([#431](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/431))
...
* Allow `PROXY` protocol for `viettelidc_lb_pool_v2` ([#375](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/375))
...
* __New Resource:__ `viettelidc_db_database_v1` ([#179](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/179))
* __New Resource:__ `viettelidc_db_user_v1` ([#180](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/180))
* __New Resource:__ `viettelidc_db_configuration_v1` ([#185](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/185))
* __New Data Source:__ `viettelidc_compute_flavor_v2` ([#190](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/190))


IMPROVEMENTS

* Added `external_fixed_ips` to the `viettelidc_networking_router_v2` resource ([#178](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/178))
* Added `ipv6_address_mode` and `ipv6_ra_mode` to the `viettelidc_networking_subnet_v2` resource and data source ([#193](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/193))
* Several new `viettelidc_networking_subnet_v2` attributes are now accessible in the data source ([#199](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/199))
* Added `availability_zone_hints` to the `viettelidc_networking_network_v2` resource and data source ([#196](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/196))
* Added `availability_zone_hints` to the `viettelidc_networking_router_v2` resource ([#203](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/203))
* User's password field in `viettelidc_db_instance_v2` resource has been marked sensitive ([#220](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/220))
* `viettelidc_db_instance_v1` now supports setting a `configuration_id` ([#221](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/221))

BUG FIXES

* Allow the same `ip_address` with a different `mac_address` to be specified multiple times in the `viettelidc_networking_port_v2` resource ([#168](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/168))
* Fixed unhandled error checks which were causing crashes in `viettelidc_networking_secgroup_v2` and `viettelidc_networking_network_v2` data sources ([#201](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/201))
* Fixed unhandled error check when creating `viettelidc_networking_floatingip_v2` ([#206](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/206))
* Fixed region detection when using `clouds.yaml` ([#216](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/216))
* Make `subnet_id` optional for `viettelidc_lb_member_v2` ([#189](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/189))
* Fix ordering of DNS servers in `viettelidc_networking_subnet_v2` ([#226](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/226))

## 1.1.0 (December 04, 2017)

FEATURES

* __New Resource:__ `viettelidc_objectstorage_object_v1` ([#146](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/146))
* __New Resource:__ `viettelidc_db_instance_v1` ([#155](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/155))

IMPROVEMENTS

* Better handling of mutually exclusive options `no_gateway` and `gateway_ip` in the `viettelidc_networking_subnet_v2` resource ([#136](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/136))
* Can now authenticate with a `clouds.yaml` file ([#154](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/154))

BUG FIXES

* Fixed issue with automatic detection of an Octavia client and Networking client ([#172](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/172))
* Fixed issue with creating public flavors ([#177](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/177))

## 1.0.0 (November 08, 2017)

BACKWARDS INCOMPATIBILITIES / NOTES:

* If your ViettelIdc cloud supports the Octavia Load Balancing service, you can now use it by setting the provider-level `use_octavia` argument to `true`. The `viettelidc_lb_*_v2` resources will then seamlessly use Octavia.

FEATURES

* __New Data Source:__ `viettelidc_networking_subnet_v2` ([#135](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/135))
* __New Data Source:__ `viettelidc_dns_zone_v2` ([#145](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/145))

IMPROVEMENTS

* `viettelidc_networking_router_v2`: Added `enable_snat` argument ([#140](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/140))
* Added provider-level option of `use_octavia` to use the Octavia load balancing service ([#149](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/149))
 ...
 * `viettelidc_networking_router_interface_v2` will now set `subnet_id` when importing ([#119](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/119))
 * `viettelidc_networking_router_route_v2` can now be imported ([#120](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/120))
 * `viettelidc_images_image_v2` resource and data source now supports reading and setting properties ([#113](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/113))

BUG FIXES

  * `viettelidc_networking_port_v2`: Fixed issues with how security groups and allowed address pairs are applied and updated [[#114](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/114)].
...
* __New Data Source:__ `viettelidc_networking_secgroup_v2` ([#86](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/86))
* __New Resource:__: `viettelidc_compute_flavor_v2` ([#83](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/83))

IMPROVEMENTS
 * Added `status` field to `viettelidc_networking_network_v2` data source ([#105](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/105))
 * `viettelidc_networking_router_v2` can now be imported ([#111](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/111))
 * `viettelidc_networking_router_interface_v2` can now be imported ([#112](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/112))

BUG FIXES

* `viettelidc_lb_listener_v2`: Don't send `connection_limit` unless it has been set ([#90](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/90))
* `viettelidc_lb_pool_v2`: Find Load Balancer via Listener ([#97](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/97))
* LBaaS v2: Removed unused `id` fields ([#93](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/93))
* `viettelidc_lb_monitor_v2`: Check if a monitor was successfully created before proceeding ([#102](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/102))
* `viettelidc_networking_router_v2`: Fix region parameter ([#107](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/107))
* `viettelidc_compute_instance_v2`: Fix regression bug with NIC detection ([#117](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/117))

## 0.2.1 (August 23, 2017)

IMPROVEMENTS:

* `viettelidc_lb_loadbalancer_v2` timeouts have been lowered to 10 and 5 minutes ([#74](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/74))

BUG FIXES:

* `viettelidc_images_image_v2` data source now sorts images by `CreatedAt` instead of `UpdatedAt` ([#78](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/78))
* `viettelidc_networking_secgroup_v2` now re-reads security group before deleteing rules when `delete_default_rules => true` ([#82](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/82))
* Fixed `viettelidc_compute_instance_v2` access IP address detection in dual-stack environments ([#85](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/85))
...
* __New Resource:__ `viettelidc_identity_project_v3` ([#50](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/50))
* __New Resource:__ `viettelidc_identity_user_v3` ([#52](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/52))

IMPROVEMENTS:

* `viettelidc_compute_instance_v2` now supports Neutron for network detection ([#39](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/39))
* `viettelidc_compute_instance_v2` support for multiple NICs on the same network ([#39](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/39))
* Added support for `TERMINATED_HTTPS` protocol in `viettelidc_lb_listener_v2` ([#49](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/49))
* Improvements to LBaaS v2 resource coordination ([#59](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/59))
* `viettelidc_lb_loadbalancer_v2.provider` has been removed. See notes above. ([#65](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/65))

BUG FIXES:
* `viettelidc_lb_pool_v2` handling of `persistence` updated, `cookie_name` is now optional. ([#57](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/57))
* `viettelidc_fw_firewall_v1.associated_routers` is now computed. ([#53](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/53))
* All `viettelidc_fw_rule_v1` attributes are now passed during an update phase. ([#53](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/53))
* `viettelidc_networking_secgroup_v2` now correctly updates description. ([#60](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/60))
* `viettelidc_fw_firewall_v1` now correctly translates `value_specs` on create. ([#66](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/66))
...
* Can specify `region` in the provider ([#25](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/25))

BUG FIXES

* Wait for LoadBalancer to be active before creating Pools and Monitors ([#29](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/29))
* Choose first network found with a matching name for compute instances ([#36](https://github.com/viettelcloud-provider/terraform-provider-viettelidc/issues/36))
